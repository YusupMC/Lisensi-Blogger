    ...
    <div id="content-wrapper" class="d-flex flex-column">
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="card mb-4">
            <div class="card-header"><?= $current_license ? 'Edit Lisensi' : 'Tambah Lisensi' ?></div>
            <div class="card-body">
              <form method="post" action="save.php">
                <input type="hidden" name="edit" value="<?= $current_license ? '1' : '0' ?>">
                <div class="form-group">
                  <input type="text" name="id" class="form-control" placeholder="ID Lisensi (unik)" value="<?= $current_license['id'] ?? '' ?>" <?= $current_license ? 'readonly' : 'required' ?>>
                </div>
                <div class="form-group">
                  <input type="text" name="domain" class="form-control" placeholder="Domain (blogspot.com)" value="<?= $current_license['domain'] ?? '' ?>" required>
                </div>
                <div class="form-group">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                        ...
                        <a href="delete.php?id=<?= $lisensi['id'] ?>" class="btn btn-sm btn-danger" onclick="return confirm('Yakin ingin menghapus lisensi ini?')"><i class="fas fa-trash"></i> Hapus</a>
                      </td>
                    </tr>
                    <?php endforeach; ?>
                  </tbody>
